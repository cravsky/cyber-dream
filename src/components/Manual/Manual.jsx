  ...
  const steps = [
    {
      ...
      image: "https://images.unsplash.com/photo-1517837125937-53bd402f49d6?auto=format&fit=crop&w=800&q=80" // Thoughtful woman
    },
    {
      icon: <FaCreditCard />,
      title: "Dokonaj płatności",
      description: "Szybka i bezpieczna płatność online.",
      image: "https://images.unsplash.com/photo-1623118176012-9b0c6fa0712d?auto=format&fit=crop&w=800&q=80" // Payment/coins
    },
    {
      icon: <FaBrain />,
      ...
      image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=800&q=80" // AI visualization
    },
    {
      icon: <FaFileDownload />,
      title: "Otrzymaj wynik",
      description: "Rezultat wyświetli się na stronie i będzie do pobrania w formacie pdf.",
      image: "https://images.unsplash.com/photo-1544032527-042957c10e40?auto=format&fit=crop&w=800&q=80" // Open book
    }
  ];
